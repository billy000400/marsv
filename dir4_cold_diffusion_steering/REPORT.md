...
80.8 ± 1.6% / 94.8 ± 1.6% at `α=8` on GPT-2 small / GPT-2 medium / Pythia / Qwen3 — the headline 84% is
reproducible, and the recipe is seed-stable across four models spanning two scales and two architectures). Off
...
| Seed-robust across 5 seeds @`α=8` (small / medium / Pythia / Qwen3) | 83.3 ± 2.0% / 88.3 ± 2.2% / 80.8 ± 1.6% / 94.8 ± 1.6% | Part 3 (Exp 26, 27, 28, 29) |
